...
export const Students =()=>{
    ...
    return(<div className="h-full flex flex-1 justify-center">
        <div className=" border-2 border-white mx-50 w-1/2">
        {Students.map(x=>
            <div className="flex justify-around h-15 items-center text-white text-2xl border-2 border-white m-2 rounded-2xl ">
